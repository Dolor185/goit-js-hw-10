...
function onSearchInput(e) {
    ...
    (0, _fetchCountries.fetchCountries)(query).then((data)=>{
        if (data.length === 1) renderCountryInfoMarkup(data);
        else if (data.length >= 2 && data.length <= 10) renderPrewiewMarkup(data);
        else onManyMatches();
    }).catch((error)=>{
        onInvalidName();
    });
...
function renderPrewiewMarkup(data) {
    const markup = data.map((0, _markup.createPrewiewMarkup)).join("");
    refs.countryList.innerHTML = markup;
}
function renderCountryInfoMarkup(data) {
    const markup = data.map((0, _markup.createCountryInfoMarkup)).join("");
...
function onInvalidName() {
    return (0, _notiflixNotifyAio.Notify).failure("Oops, there is no country with that name");
}

},{"./css/styles.css":"1CY4s","./js/fetchCountries":"dKuy9","./js/markup":"3TIfq","lodash.debounce":"3JP5n","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createPrewiewMarkup", ()=>createPrewiewMarkup);
parcelHelpers.export(exports, "createCountryInfoMarkup", ()=>createCountryInfoMarkup);
